...
const ActivityLog = ({ selectedChild }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Header */}
      <div className="flex flex-col gap-3 sm:flex-col md:flex-row md:items-center md:justify-between lg:flex-row lg:items-center lg:justify-between">
        <div>
          <h1 className="text-2xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-text mb-2">
            {selectedChild.name}'s Activity Log 📚
          </h1>
          <p className="text-text/60">Complete history of learning activities</p>
        </div>
            ...
            <div className="space-y-3">
              {dayData.activities.map((activity, actIndex) => (
                <motion.div key={activity.id || actIndex}
                  initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}
                  transition={{ delay: dayIndex * 0.08 + actIndex * 0.05 }}
                  className="flex flex-col sm:flex-col md:flex-row lg:flex-row items-start gap-3 sm:gap-3 md:gap-4 lg:gap-4 p-4 bg-gray-50 rounded-2xl hover:bg-gray-100 transition-colors">
                  ...
                  <div className="flex-1 w-full">
                    <div className="flex flex-col sm:flex-col md:flex-row lg:flex-row items-start justify-between gap-2 mb-2">
                      <div>
                        <h3 className="font-semibold text-text text-lg">
                          {activity.activityName || 'Activity'}
                        </h3>
